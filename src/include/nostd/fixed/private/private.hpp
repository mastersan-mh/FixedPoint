...
{
public:
    FIXEDPOINT_INLINE FixedPoint() noexcept : value(0)
    {
    }

    FIXEDPOINT_INLINE FixedPoint(const FixedPoint & other_) noexcept : value(other_.value)
    {
    }

    FIXEDPOINT_INLINE explicit FixedPoint(Tfixed_t val_) noexcept : value(val_)
    {
    }

    FIXEDPOINT_INLINE explicit FixedPoint(double val_) noexcept : value(DOUBLE_TO_FIXED(Tfixed_t, Tfracbits, val_))
    {
    }
    ...
    /* operators: binary */
    FIXEDPOINT_INLINE FixedPoint& operator=(const FixedPoint& right_) noexcept
    {
        value = right_.value;
        return *this;
    }

    FIXEDPOINT_INLINE FixedPoint& operator=(Tfixed_t right_) noexcept
    {
        value = right_;
        return *this;
    }

    FIXEDPOINT_INLINE FixedPoint& operator=(double right_) noexcept
    {
    ...
    FIXEDPOINT_INLINE FixedPoint operator+(const FixedPoint& right_) const noexcept
    {
    ...
    FIXEDPOINT_INLINE bool operator==(const FixedPoint& right_) const noexcept
    {
    ...
    /* methods */
    FIXEDPOINT_INLINE void setRawFixed(Tfixed_t val_) noexcept
    {
        value = val_;
    }

    FIXEDPOINT_INLINE void set(const FixedPoint & other_) noexcept
    {
        value = other_.value;
    }

    FIXEDPOINT_INLINE void set(double val_) noexcept
    {
